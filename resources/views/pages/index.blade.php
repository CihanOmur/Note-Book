                        ...
                        @foreach($Notes as $Key => $Note)
                            <div class="intro-y col-span-6 sm:col-span-4 md:col-span-3 xxl:col-span-4">
                                <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                                    <a href="show/{{ $Note->id}}" class="w-3/5 file__icon file__icon--file mx-auto"></a>
                                    <a href="show/{{ $Note->id}}" class="block font-medium mt-4 text-center truncate">{{ $Note->note_title }}</a>
                                    <div class="text-gray-600 text-xs text-center mt-0.5">{{ $Note->created_at }}</div>
                                    <div class="absolute top-0 right-0 mr-2 mt-2 dropdown ml-auto">
                                        ...
                                        <div class="dropdown-menu w-40">
                                            <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                                <a href="delete/{{ $Note->id}}" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="trash" class="w-4 h-4 mr-2"></i> Move To Trash </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
